...
@section('vite')
@vite(['resources/css/app.css', 'resources/css/panel/lab/desc.css', 'resources/js/jquery.js'])
@endsection
...
<div class="outsideBig">
    <div class="insideBig">
        ...
        @if ($rota->images()->exists() != null)
        <img class="img" src=" {{Storage::url($rota->images[0]['img'])}}">
        @else
...
<div class="content">
    ...
    <div class="containerLab">
        ...
        <div class="outside">
            <div class="inside">
                <a href="{{ route('panel.rota.desc', $el['id']) }}">
                    <img class="img" src=" {{Storage::url($el['svg'])}}">
                </a>
            </div>
        </div>
        @endforeach
